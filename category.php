...
?>
<?php include_once('includes/themes/' . $theme . '/header-category.php'); ?>
<!--  get header -->
...
<!--  fetch posts data -->
<?php include_once('includes/themes/' . $theme . '/view/post-category.php'); ?>

<!--  get sidebar -->
<?php include_once('includes/themes/' . $theme . '/sidebar.php'); ?>

<!--  get pages -->
<?php include_once('includes/themes/' . $theme . '/view/navigation-category.php'); ?>
