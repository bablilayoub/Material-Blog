...
$getinfo = $conn->query("SELECT id FROM pages WHERE slug = '$slug_url'");
...
<head>
    ...
    ?>
            <title><?php echo $settings['sitename']; ?> - <?php echo $pages['name']; ?></title>
        <?php
        } else {
        ?>
            <title><?php echo $settings['sitename']; ?> - <?php echo $pages['name']; ?></title>
        ...
        if (!empty($row)) {
            ...
            $posts = mysqli_fetch_assoc($runPQ);
        ?>
            <title><?php echo $settings['sitename']; ?> - <?php echo $categories['name']; ?></title>
        <?php
        } else {
        ?>
