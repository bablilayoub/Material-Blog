...
<div id="intro" class="p-5 text-center bg-light">
  <h1 class="mb-3 h2"><?php echo $categories['name']; ?></h1>
  <?php $checkdata = $settings['show_description'];
  $set = "yes";
  if ($checkdata == $set) {
  ?>
    <p class="mb-3"><?php echo $categories['description']; ?></p>
  <?php
  } else {
  }
  ?>
      ...
      <div class="col-md-9 mb-4">
        ...
        <section>
          ...
          if (isset($_GET['search'])) {
            ...
            $status = 1;
            $postQuery = "SELECT * FROM posts WHERE category_id = $dataid AND status=$status ORDER BY id DESC LIMIT $result,$post_per_page";
          }
