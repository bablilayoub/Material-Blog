...
<head>
    ...
    <title><?php echo $settings['sitename']; ?> - Manage Ads</title>
    <!-- Font Awesome -->
                    ...
                    <div class="mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $adstatus ?></td>
                                            <td>
                                                <a type="button" href="includes/edit/edit-ad.php?id=<?= $ad['id'] ?>" class="btn btn-success btn-rounded btn-floating">
                                ...
                                <?php
                                $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM ads");
                                $row_db = mysqli_fetch_row($result_db);
                                $total_records = $row_db[0];
                                $total_pages = ceil($total_records / $limit);
                                $pagLink = "<ul class='pagination'>";
                                for ($i = 1; $i <= $total_pages; $i++) {
                                    $pagLink .= "<li class='page-item'><a class='page-link' href='manage-ads.php?page=" . $i . "'>" . $i . "</a></li>";
                                }
                                echo $pagLink . "</ul>";
                                ?>
                            </div>
