    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
                ...
                <a href="/admin/add-post.php" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table align-middle">
                                ...
                                <!--Section: add posts-->
                                <form action="includes/files/add-post.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Post Title</label>
                                            <input type="text" class="form-control" name="post_title" required>
                                            <input type="text" value="<?php echo $id; ?>" class="form-control" name="publisher" required hidden>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="post_slug" placeholder="Leave this place blank to generate a random slug or use custom one">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control ckeditor" name="post_description" rows="2" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea id="post_content" class="form-control ckeditor" name="post_content"></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
