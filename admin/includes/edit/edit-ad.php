...
<head>
    ...
    <title><?php echo $settings['sitename']; ?> - Edit Ad</title>
    <!-- Font Awesome -->
    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
                ...
                <a href="/admin/manage-ads.php" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true"><i class="fas fa-tools fa-fw me-3"></i><span>Manage Ads</span></a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table align-middle">
                                ...
                                <!--Section: add posts-->
                                <form action="../files/edit-ad.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Ad Name</label>
                                            <input type="text" value="<?= $Addata['name'] ?>" class="form-control" name="ad_name" required>
                                            <input type="text" value="<?= $Addata['id'] ?>" class="form-control" name="ad_id" required hidden>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Ad Code / Text</label>
                                            <textarea id="ad_code" class="form-control ckeditor" name="ad_code"><?= $Addata['code'] ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select name="enable_ad" class="form-control" required>
                                                <?php
                                                $ad_status = $Addata['status'];
                                                $settext = "1";
                                                if ($ad_status == $settext) {
                                                ?>
                                    ...
                                    <br>
                                    <div class="card">
                                        <input type="submit" name="edit_ad" class="btn btn-primary" value="SUBMIT">
