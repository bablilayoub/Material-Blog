...
<head>
    ...
    <title><?php echo $settings['sitename']; ?> - Edit Post</title>
    <!-- Font Awesome -->
...
<body>
    ...
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="/admin/manage-posts.php" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true"><i class="fas fa-folder-open fa-fw me-3"></i><span>Manage Post</span></a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table align-middle">
                                ...
                                <!--Section: add posts-->
                                <form action="../files/edit-post.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Post Title</label>
                                            <input type="text" value="<?= $postdata['title'] ?>" class="form-control" name="post_titel" required>
                                            <input type="text" value="<?= $postdata['id'] ?>" class="form-control" name="post_id" required hidden>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control ckeditor" name="post_description" rows="2" required><?= $postdata['description'] ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea id="post_content" class="form-control ckeditor" name="post_content"><?= $postdata['content'] ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="submit" name="savedraft" class="btn btn-primary" value="Save Draft">
    ...
    <script type="text/javascript">
        tinymce.init({
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                xhr.open('POST', '../files/upload.php');
