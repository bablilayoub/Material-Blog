...
<head>
    ...
    <title><?php echo $settings['sitename']; ?> - Edit Page</title>
    <!-- Font Awesome -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table align-middle">
                                ...
                                <!--Section: add posts-->
                                <form action="../files/edit-page.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Page Title</label>
                                            <input type="text" value="<?= $pagedata['name'] ?>" class="form-control" name="page_titel" required>
                                            <input type="text" value="<?= $pagedata['id'] ?>" class="form-control" name="page_id" required hidden>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control ckeditor" name="page_description" rows="2" required><?= $pagedata['description'] ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea id="post_content" class="form-control ckeditor" name="page_content"><?= $pagedata['content'] ?></textarea>
                                        </div>
                                    </div>
                                    <br>

                                    <div class="card">
                                        <input type="submit" name="editpage" class="btn btn-primary" value="SUBMIT">
