                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table align-middle">
                                ...
                                <form action="../files/update-adblock.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Adblock Title</label>
                                            <input type="text" value="<?= $titel; ?>" class="form-control" name="plugin_titel" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Adblock Description</label>
                                            <textarea class="form-control ckeditor" name="plugin_description" rows="3" required><?= $description; ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Enable Adblock</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label>Show Adblock For</label>
                                            <select name="forwhow" class="form-control" required>
                                                <?php
                                                $getstatus = $for;
                                                $settext = 1;
                                                if ($getstatus == $settext) {
                                                ?>
                                                    <option value="1">Admins And Members</option>
                                                    <option value="0">Only Members And Visitors</option>
                                                <?php
                                                } else {
                                                ?><option value="0">Only Members And Visitors</option>
                                                    <option value="1">Admins And Members</option>
