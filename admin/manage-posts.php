...
<head>
  ...
  <title><?php echo $settings['sitename']; ?> - Manage Posts</title>
  <!-- Font Awesome -->
...
<body>
  ...
  max-width: 50ch;"><?= $post['title'] ?></td>
                      ...
                      <td>
                        ...
                        <a type="button" href="<?php echo _SITE_URL ?>/<?= $post['slug'] ?>" target="_blank" class="btn btn-primary btn-rounded btn-floating">
