...
<head>
  ...
  <title><?php echo $settings['sitename']; ?> - Manage Pages</title>
  <!-- Font Awesome -->
            ...
            <section>
              <div class="row">
                <div class="mb-4">
                  <div class="card">
                    <div class="card-body">
                      <a class="btn btn-primary" href="<?php echo _SITE_URL ?>/admin/add-page.php">
                        Add New Page
                      </a>
                    </div>
                  </div>
          ...
          <div class="mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <table class="table align-middle">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a type="button" href="includes/files/delete-page.php?id=<?= $page['id'] ?>" onclick="return confirm('Do You Really Want To Delete this Page ?');" class="btn btn-danger btn-rounded btn-floating">
                          <i class="fas fa-trash-alt"></i>
                        </a>
                        <a type="button" href="includes/edit/edit-page.php?id=<?= $page['id'] ?>" class="btn btn-success btn-rounded btn-floating">
                          <i class="fas fa-edit"></i>
                        </a>
                        <a type="button" href="<?php echo _SITE_URL ?>/page<?= $page['slug'] ?>" target="_blank" class="btn btn-primary btn-rounded btn-floating">
                ...
                <?php
                $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM pages");
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                  $pagLink .= "<li class='page-item'><a class='page-link' href='manage-pages.php?page=" . $i . "'>" . $i . "</a></li>";
                }
                echo $pagLink . "</ul>";
                ?>
              </div>
