...
<head>
    ...
    <title><?php echo $settings['sitename']; ?> - Manage Plugins</title>
    <!-- Font Awesome -->
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <thead>
                                        ...
                                        <?php
                                        $limit = 10;
                                        $plugins = getAllPlugins($conn, $limit);
                                        $count = 1;
  ...
  max-width: 50ch;"><a href="<?php echo $settings['url']; ?>/admin/includes/plugins/<?= $plugin['link'] ?>"><?= $plugin['name'] ?></a></td>
                                            <td><?= $plugin['version'] ?></td>
                                            <td><img src="<?php echo $settings['url']; ?>/<?= $plugin['image'] ?>" alt="" height=40 width=200></img></th>
                                            <td>


                                                </form>
                                                <a type="button" href="<?php echo $settings['url']; ?>/admin/includes/plugins/<?= $plugin['link'] ?>" class="btn btn-success btn-rounded btn-floating">
                                ...
                                <?php
                                $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM plugins");
                                ...
                                for ($i = 1; $i <= $total_pages; $i++) {
                                    $pagLink .= "<li class='page-item'><a class='page-link' href='plugins.php?page=" . $i . "'>" . $i . "</a></li>";
                                }
                                echo $pagLink . "</ul>";
                                ?>
                            </div>
