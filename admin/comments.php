...
<head>
  ...
  <title><?php echo $settings['sitename']; ?> - Manage Comments</title>
  <!-- Font Awesome -->
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="/admin/comments.php" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true"><i class="fas fa-comments fa-fw me-3"></i><span>Manage Comments</span></a>
              ...
              <div class="card-body">
                ...
                <table class="table align-middle">
                  <thead>
                    ...
                    <?php
                    $limit = 10;
                    $comments = getAllComments($conn, $limit);
                    $count = 1;
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a type="button" href="includes/files/delete-comment.php?id=<?= $comment['id'] ?>" onclick="return confirm('Do You Really Want To Delete this Comment ?');" class="btn btn-danger btn-rounded btn-floating">
                ...
                <?php
                $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM comments");
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                  $pagLink .= "<li class='page-item'><a class='page-link' href='comments.php?page=" . $i . "'>" . $i . "</a></li>";
                }
                echo $pagLink . "</ul>";
                ?>
              </div>
